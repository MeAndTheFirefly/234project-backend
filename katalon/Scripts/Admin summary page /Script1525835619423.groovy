...
WebUI.verifyElementPresent(findTestObject('Admin Summary/th_Transaction ID'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/th_Products'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/th_1'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/td_1'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/td_Garden Papaya'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/td_20120 THB'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/th_2'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/td_2'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/td_Banana Garden Banana Rambut'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/td_60570 THB'),0)

WebUI.verifyElementPresent(findTestObject('Admin Summary/strong_Total price'),0)
