...
public class ProductServiceTests {
	...
	public void testGetAllProdMock() {
		...
		assertThat(list.get(0), is(new Product("p01", "Den", "My garden den", "http://localhost:8080/images/p01.jpg", 11)));
		assertThat(list.get(1), is(new Product("p02", "Ban", "Thai house", "http://localhost:8080/images/p02.jpg", 22)));
		assertThat(list.get(2), is(new Product("p03", "Org", "Nasty fruit", "http://localhost:8080/images/p03.jpg", 33)));
		assertThat(list.get(3), is(new Product("p04", "Pap", "Nice fruit", "http://localhost:8080/images/p04.jpg", 44)));
		assertThat(list.get(4), is(new Product("p05", "Ram", "Southern fruit", "http://localhost:8080/images/p05.jpg", 55)));
		assertThat(list.get(5), is(new Product("p06", "Oop", "My mistake", "http://localhost:8080/images/p06.jpg", -1)));
	}
